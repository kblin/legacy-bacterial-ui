    ...
    .controller('AsStartCtrl', ['$state', '$window', 'Upload',
        function ($state, $window, Upload) {
            ...
            vm.submit = function (form) {
                vm.submission.jobtype = `experimentalsmash-${vm.selected_jobtype.id}`;
            ...
            vm.openSampleOutput = function () {
                $window.location.href = `/upload/${vm.selected_jobtype.id}-example/index.html`;
            }
